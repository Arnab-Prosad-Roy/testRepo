 ...
 <div id="account-login" class="container">
  <ul class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12">
          <div class="well">
            <h2 class="heading">Returning Customer</h2>
            <p><strong>I am a returning customer</strong></p>
            <form action="http://templateinspire.com/opencart/Grocery/index.php?route=account/login" method="post" enctype="multipart/form-data">
              ...
              <input type="submit" value="Login" class="btn btn-primary" />
                            <input type="hidden" name="redirect" value="http://templateinspire.com/opencart/Grocery/index.php?route=account/account" />
                          </form>
          </div>
        </div>
      </div>
